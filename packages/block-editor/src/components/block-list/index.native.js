...
export class BlockList extends Component {
	...
	renderItem( { item: clientId, index } ) {
		...
		const shouldPutAddBlockSeparatorAbove = this.isReplaceable( this.props.selectedBlock ) || this.props.isPostTitleSelected;

		return (
			<ReadableContentView reversed={ shouldPutAddBlockSeparatorAbove }>
				<BlockListBlock
					key={ clientId }
					showTitle={ false }
					clientId={ clientId }
